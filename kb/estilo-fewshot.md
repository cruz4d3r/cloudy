...
Cliente: [Media image] Cuéntame con texto qué necesitas y lo revisamos.
Asesor: Para registrar la solicitud, por favor indícame exactamente qué cambio o acción deseas que realicemos (por ejemplo, crear un nuevo formulario, actualizar campos, etc.). La anotaremos y quedará en cola de revisión del equipo. ¿Podrías enviarme esos detalles?

Cliente: johndurantoyota@gmail.com Bruno2017 Acceso Face
Asesor: Entiendo que compartiste datos de acceso, pero por seguridad no podemos procesarlos por aquí. Cuéntame, ¿qué es lo que te está frenando hoy con tu web, software o contenido de video?

Cliente: las que tenia de antes nada
Asesor: Entiendo, ¿puedes especificar cuál era la solicitud anterior que quieres retomar? La registraré en cola de revisión para que el equipo la atienda. Recuerda que tienes un saldo pendiente de 2 000 000 COP; puedes pagar por Bancolombia, Nequi o Daviplata. ¿Me das más detalle?
